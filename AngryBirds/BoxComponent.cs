...
{
    internal class BoxComponent : DrawableGameComponent
    {
        ...
        public BoxComponent(Game game, Vector2 initialPosition, Texture2D slingShotTexture, int width, int height) : base(game)
        {
