...
{
    internal class PigComponent : DrawableGameComponent
    {
        ...
        public PigComponent(Game game, Vector2 initialPosition, Texture2D slingShotTexture, int width, int height) : base(game)
        {
